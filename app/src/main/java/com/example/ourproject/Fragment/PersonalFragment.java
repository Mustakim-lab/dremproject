...
public class PersonalFragment extends Fragment {
    ...
    EditorPersonalAdapter editorPersonalAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.editorPersonalRecyclerView_ID);
    ...
    private void redUser() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                editorPersonalAdapter = new EditorPersonalAdapter(getContext(), profileModelList);
                recyclerView.setAdapter(editorPersonalAdapter);
            }
