...
public class EditorMemberFragment extends Fragment {

    RecyclerView recyclerView;
    EditorUserAdapter editorUserAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_editor_member, container, false);

        recyclerView=view.findViewById(R.id.editorMemberRecyclerView_ID);
    ...
    private void redUser() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                editorUserAdapter=new EditorUserAdapter(getContext(),profileModelList);
                recyclerView.setAdapter(editorUserAdapter);
            }
