...
public class EditorPersonalAdapter  extends RecyclerView.Adapter<EditorPersonalAdapter.MyViewHolder>{
    Context context;
    List<ProfileModel> profileModelList;
    String editorUserID;

    public EditorPersonalAdapter(Context context, List<ProfileModel> profileModelList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent=new Intent(context, EditorPersonalActivity.class);
            intent.putExtra("editor_personalID",editorUserID);
